    ...
    <div class="smart-wrap">
        <div class="smart-forms smart-container wrap-2">
            ...
            <div class="form-header header-primary">
                ...
                <h4 style="text-align:center">My Feedback -
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <asp:HyperLink ID="HypHome" runat="server">Home</asp:HyperLink></li>
                <li>Your Stay</li>
            </ul>
                ...
                <asp:Panel runat="server" ID="FormBody" CssClass="form-body">
                    ...
                    <div id="ctr_room" class="hiddenbox">
                                ...
                                <div class="option-group field">
                                    <div class="smart-option-group smart-option-list group-vertical">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="file" class="dropify" data-allowed-file-extensions="jpg JPG jpeg png" data-height="100" data-max-file-size="10M">
                        ...
                        <asp:Panel ID="PnlLoginBtnContainer" runat="server">
                                ...
                                <a href="#" style="width:30%" onclick="validateForm()" data-smart-modal="#smart-modal1" class="button btn-primary smartforms-modal-trigger">Report</a>
                        ...
                        <asp:Panel ID="PnlNoLoginBtnContainer" Visible="false" runat="server">
                                ...
                                <asp:Button ID="NoLoginBtnSubmit" Width="30%" OnClientClick="fillHiddenFields()" OnClick="NoLoginSubmit_Click" CssClass="button btn-primary" runat="server" Text="REPORT " />
