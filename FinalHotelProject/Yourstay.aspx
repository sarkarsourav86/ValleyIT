                ...
                <asp:Panel runat="server" ID="FormBody" CssClass="form-body">
                    ...
                    <div id="ctr_room" class="hiddenbox">
                        ...
                        <asp:Panel ID="PnlLoginBtnContainer" runat="server">
                                ...
                                <a href="#" style="width:20%" onclick="validateForm()" data-smart-modal="#smart-modal1" class="button btn-primary smartforms-modal-trigger">Report</a>
                        ...
                        <asp:Panel ID="PnlNoLoginBtnContainer" Visible="false" runat="server">
                                ...
                                <asp:Button ID="NoLoginBtnSubmit" Width="20%" OnClientClick="fillHiddenFields()" OnClick="NoLoginSubmit_Click" CssClass="button btn-primary" runat="server" Text="REPORT " />
