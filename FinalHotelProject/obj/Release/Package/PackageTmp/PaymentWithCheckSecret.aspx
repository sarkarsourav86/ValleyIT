<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentWithCheckSecret.aspx.cs" Inherits="FinalHotelProject.PaymentWithCheckSecret" %>
            ...
            <form id="form1" runat="server">
                <div class="form-body">
                    ...
                    <div class="fmx">
                        ...
                        <div class="section">
                            <label class="field prepend-icon">
                                <asp:TextBox ID="TxtCardName"  runat="server" CssClass="gui-input" placeholder="Name on card..."></asp:TextBox>
                                <span class="field-icon"><i class="fa fa-user"></i></span>
                            </label>
                        </div>
                        <!-- end section -->
                        ...
                        <div class="section">
                            <label class="field prepend-icon">
                                <asp:TextBox runat="server" ID="TxtCardNo"  CssClass="gui-input" placeholder="Card number..."></asp:TextBox>
