        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div id="demo-form3" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <asp:Panel ID="PnlPwdChangeStatus" runat="server" Visible="false" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                        <asp:Literal runat="server" ID="LitLabelText" Text="ghgfhfgh"></asp:Literal>
                    </asp:Panel>
                    <div class="form-group">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div id="demo-form3" data-parsley-validate class="form-horizontal form-label-left">
                    ...
                    <asp:Panel ID="PnlAddUserStatus" runat="server" Visible="false" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                        <asp:Literal runat="server" ID="LitAddUserStatus" Text="ghgfhfgh"></asp:Literal>
                    </asp:Panel>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <asp:Button runat="server" ID="BtnAddUser" Text="Update" OnClick="BtnAddUser_Click" class="btn btn-success" />
                        </div>
                    </div>
